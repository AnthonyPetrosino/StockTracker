...
class UserRegistrationForm(forms.ModelForm):
    ...
    password_confirm = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"placeholder": "Confirm your password", "class": "form-input"}
        )
    )
    ...
    class Meta:
        ...
        widgets = {
            "username": forms.TextInput(
                attrs={"placeholder": "Enter your username", "class": "form-input"}
            ),
            "email": forms.EmailInput(
                attrs={"placeholder": "Enter your email address", "class": "form-input"}
            ),
        }
        labels = {"username": "", "email": "", "password": "", "password_confirm": ""}
