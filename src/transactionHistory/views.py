...
def transactionHistory(request):
    ...
    user_transactions = StockTransaction.objects.filter(
    ...
    user_history = [
        {
            ...
            ),  # Ensure stock_price is float for JSON serialization
    ...
    return render(
        request,
        "transactionHistory/transactionHistory.html",
        {
...
def TransactionHistory(request):
    ...
    for transaction in user_transactions:
        ...
        ] = {  # Store all of the user_transactions data into the dict
            "quantity": float(transaction.stock_quantity),
    ...
    return JsonResponse({"transaction_history": transactions_dict})
